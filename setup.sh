...
command -v pyenv >/dev/null 2>&1 || { echo "I require pyenv but it's not installed.  Aborting." >&2; exit 1; }


pyenv virtualenv --version gcc-5-glibc-2.23/3.6.3rc1+ neovim;
source /home/vuzdylan/virtualenvs/neovim/bin/activate;
